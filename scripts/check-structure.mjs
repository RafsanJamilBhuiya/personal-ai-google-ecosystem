...
const required=['README.md','.gitignore','.env.example','LICENSE','package.json','package-lock.json','wrangler.toml','backend/worker.js','frontend/index.html','frontend/css/app.css','frontend/js/app.js'];
