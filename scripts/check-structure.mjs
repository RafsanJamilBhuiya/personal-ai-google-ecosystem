...
const required=['README.md','.gitignore','.env.example','LICENSE','package.json','package-lock.json','wrangler.toml','backend/worker.js','backend/integrations/registry.js','frontend/index.html','frontend/css/app.css','frontend/js/app.js','frontend/pages/admin-profile.html','frontend/pages/app-integrations.html'];
